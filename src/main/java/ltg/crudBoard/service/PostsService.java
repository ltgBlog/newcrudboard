...
public class PostsService
{
    ...
    @Transactional
    public Long save(String nickname, PostsSaveRequestDto requestDto, MultipartFile file) throws IOException {
        ...
        requestDto.setFilepath("src/main/resources/static/files/" + filename);
